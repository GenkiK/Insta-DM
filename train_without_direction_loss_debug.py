...
def main():
    ...
    for _ in range(args.epochs):
        train(args, train_loader, disp_net, ego_pose_net, obj_pose_net, optimizer)


def train(args, train_loader, disp_net, ego_pose_net, obj_pose_net, optimizer):
    global n_iter
...
def ego_pose_loss(
    ...
    # L2Norm
    print("batch_pred_pose[:, 3:], mat2euler(gt_rot_mats)")
    print(batch_pred_pose[:, 3:])
    print(mat2euler(gt_rot_mats))

    print("batch_pred_pose[:, :3], gt_translation_vecs")
    print(batch_pred_pose[:, :3])
    print(gt_translation_vecs)
