...
class RandomScaleCrop(object):
    ...
    def __call__(self, images, segms, intrinsics):
        ...
        cropped_images = [im[offset_y : offset_y + h, offset_x : offset_x + w] for im in scaled_images]
        cropped_segms = [im[offset_y : offset_y + h, offset_x : offset_x + w] for im in scaled_segms]
